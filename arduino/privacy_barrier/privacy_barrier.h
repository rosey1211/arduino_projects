...
float g_percentage_active_led_blocks = 0.5;
int *g_just_inactive_led_block_list=NULL;
...
int g_maxTimeAtBrightnessLevelMS = 5000;
float g_brightnessChangeAmount = 0.001;
