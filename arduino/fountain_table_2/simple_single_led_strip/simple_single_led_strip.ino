...
bool use_upper_led_strip = true; // this is the smaller front member
bool use_lower_led_strip = false; // this is the larger back member

bool use_temporal_rainbow=true;
bool use_comet=false;
