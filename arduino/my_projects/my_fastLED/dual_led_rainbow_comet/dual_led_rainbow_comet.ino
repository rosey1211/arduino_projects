...
CRGB comet_tail_color(25,10,100);
...
{
  //char line[100];
  //sprintf(line,"in adjustComet\n");
  //Serial.println(line);
#if 0
  for(int i=0;i<num_leds;i++)
  {
    led_array[i] = initial_array[i];
  }
  return;
#endif  
